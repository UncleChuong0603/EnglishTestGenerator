...
export function ActiveLearnerLinks({ items, review, secondary, label, locale, account, settingsLabel, signOutLabel }: Props) {
  ...
  const mobileMoreActive = reviewActive || mobileMoreItems.some(item => matches(path, item.href)) || matches(path, "/settings") || matches(path, "/billing");
