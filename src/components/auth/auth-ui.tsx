...
export function AuthShell({ children, title, intro, eyebrow }: AuthShellProps) {
  return (
    <main className="min-h-[100svh] bg-[#f6f8f8] text-slate-950 lg:grid lg:grid-cols-[minmax(0,1.08fr)_minmax(480px,.92fr)]">
      ...
      <section className="flex min-h-[100svh] items-start justify-center px-4 py-5 sm:px-8 sm:py-10 lg:items-center lg:px-10 lg:py-12">
        <div className="w-full max-w-[460px]">
          <div className="mb-8 flex items-center justify-between lg:hidden"><BrandMark /><Link className="text-sm font-bold text-slate-500 transition-colors hover:text-teal-700" href="/">Trang chủ</Link></div>
