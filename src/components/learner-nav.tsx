...
export function LearnerNav({ locale }: { locale: InterfaceLanguage }) {
  ...
  const items = [{ href: "/dashboard", label: t.navigation.dashboard }, { href: "/practice", label: t.navigation.practice }, { href: "/progress", label: t.navigation.progress }, { href: "/demo-test", label: t.demoTest.shortTitle }];
