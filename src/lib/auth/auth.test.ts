...
describe("auth flow contracts", () => {
  const service = readFileSync("src/lib/auth/service.ts", "utf8"); const callback = readFileSync("src/app/auth/callback/route.ts", "utf8"); const sessions = readFileSync("src/lib/auth/session.ts", "utf8");
