...
export type RateLimitAction = "signup" | "login" | "forgot_password" | "reset_password" | "resend_verification" | "google_oauth";
const limits: Record<RateLimitAction, { attempts: number; windowMs: number }> = {
  signup: { attempts: 5, windowMs: 3_600_000 }, login: { attempts: 10, windowMs: 900_000 }, forgot_password: { attempts: 5, windowMs: 3_600_000 }, reset_password: { attempts: 8, windowMs: 3_600_000 }, resend_verification: { attempts: 5, windowMs: 3_600_000 }, google_oauth: { attempts: 20, windowMs: 900_000 },
};
