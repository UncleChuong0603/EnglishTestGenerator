...
export const guides = {
  toeic: {
    ...
    links: [{ href: "/toeic/part-5", label: "TOEIC Part 5", description: "Ngữ pháp và từ vựng trong câu ngắn." }, { href: "/toeic/part-6", label: "TOEIC Part 6", description: "Dùng ngữ cảnh của cả đoạn văn." }, { href: "/toeic/part-7", label: "TOEIC Part 7", description: "Đọc tài liệu và đối chiếu thông tin." }, { href: "/blog/kinh-nghiem-thi-toeic-ngay-thi", label: "Checklist ngày thi TOEIC", description: "Chuẩn bị giấy tờ, thời gian và cách giữ nhịp làm bài." }, { href: "/blog", label: "Thư viện hướng dẫn", description: "Lộ trình học và mẹo sửa lỗi." }],
  ...
  part5: {
    ...
    links: [{ href: "/toeic/part-5/word-form", label: "Luyện 5 câu Word Form", description: "Chọn loại từ và xem giải thích sau khi nộp." }, { href: "/blog/ngu-phap-toeic-part-5-can-hoc", label: "7 chủ điểm ngữ pháp", description: "Đọc thêm cách chọn chủ điểm cần học." }, { href: "/blog/tu-vung-toeic-theo-chu-de-cong-so", label: "Từ vựng công sở theo cụm", description: "Học ngữ cảnh và các cụm từ thường đi cùng nhau." }, { href: "/blog/sua-de-mau-ets-toeic-2025-reading-part-5-6-7", label: "Sửa đề mẫu ETS Reading", description: "Xem cách giải thích câu Part 5 trong đề mẫu công khai." }],
  ...
  part6: {
    ...
    links: [{ href: "/toeic/part-5", label: "TOEIC Part 5", description: "Ôn cấu trúc câu trước khi đọc đoạn." }, { href: "/toeic/part-7", label: "TOEIC Part 7", description: "Tiếp tục với đọc hiểu tài liệu." }, { href: "/blog/sua-de-mau-ets-toeic-2025-reading-part-5-6-7", label: "Sửa đề mẫu ETS Part 6", description: "Đối chiếu dấu hiệu ngữ cảnh trong một đoạn văn thật." }, { href: "/blog", label: "Bài viết TOEIC", description: "Lộ trình và chiến lược học theo mục tiêu." }],
