...
export default async function PracticePage({ searchParams }: Props) {
  ...
  const [profile, preferences, progress] = await Promise.all([getCurrentProfile(user.id), getPreferences(user.id), getToeicProgress(user.id)]); if (profile.status === "missing") redirect("/onboarding");
