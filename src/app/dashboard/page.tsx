    ...
    <main className="min-h-screen bg-slate-50 px-5 py-8 text-slate-900">
      <div className="mx-auto max-w-6xl">
        <header className="flex items-center justify-between gap-4">
          ...
          <form action={signOut}>
            <button className="rounded-xl border border-slate-300 bg-white px-4 py-2 font-semibold" type="submit">
              Sign out
            </button>
          </form>
        </header>
        <section className="mt-10 rounded-3xl bg-slate-900 p-8 text-white sm:p-10">
          ...
          <h1 className="mt-3 text-4xl font-black">
            Welcome, {profileResult.profile.full_name ?? "learner"}
          </h1>
          <p className="mt-3 max-w-2xl leading-7 text-slate-300">
            The TOEIC Listening &amp; Reading question bank foundation is ready. Curated Part 5 practice will be
            enabled after the initial content has been reviewed and published.
          </p>
        </section>
