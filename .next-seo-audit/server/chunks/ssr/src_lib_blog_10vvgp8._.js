module.exports=[65725,a=>{"use strict";a.s(["CATEGORY_LABELS",0,{TOEIC_STRATEGY:{vi:"Chiến lược TOEIC",en:"TOEIC Strategy"},LISTENING:{vi:"Listening",en:"Listening"},READING:{vi:"Reading",en:"Reading"},GRAMMAR:{vi:"Ngữ pháp",en:"Grammar"},VOCABULARY:{vi:"Từ vựng",en:"Vocabulary"},STUDY_PLAN:{vi:"Kế hoạch học",en:"Study Plan"},EXAM_TIPS:{vi:"Mẹo thi",en:"Exam Tips"}},"POST_CATEGORIES",0,["TOEIC_STRATEGY","LISTENING","READING","GRAMMAR","VOCABULARY","STUDY_PLAN","EXAM_TIPS"],"STATUS_LABELS",0,{DRAFT:"Bản nháp",PUBLISHED:"Đã xuất bản",UNPUBLISHED:"Chưa xuất bản"},"safeHref",0,function(a){let b=a.trim();return b.startsWith("/")&&!b.startsWith("//")||b.startsWith("#")||/^https?:\/\//i.test(b)||/^mailto:/i.test(b)?b:null},"slugify",0,function(a){return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/đ/g,"d").replace(/Đ/g,"D").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,120)},"validatePost",0,function(a,b=!1){var c,d;let e=[];return a.title.trim()||e.push("TITLE_REQUIRED"),c=a.slug,/^[a-z0-9]+(?:-[a-z0-9]+)*$/.test(c)&&c.length<=120||e.push("SLUG_INVALID"),a.excerpt.length>320&&e.push("EXCERPT_TOO_LONG"),a.canonicalPath&&!(!(d=a.canonicalPath)||/^\/(?!\/)[a-z0-9/_-]*$/.test(d))&&e.push("CANONICAL_PATH_INVALID"),b&&!a.content.trim()&&e.push("CONTENT_REQUIRED"),b&&!a.excerpt.trim()&&e.push("EXCERPT_REQUIRED"),e}])},22937,a=>{"use strict";let b={publishedAt:new Date("2026-09-20T02:00:00.000Z"),createdAt:new Date("2026-09-20T02:00:00.000Z"),updatedAt:new Date("2026-09-20T02:00:00.000Z")},c=(a,b)=>({name:a,slug:b});function d(a){let c;return{...a,...b,status:"PUBLISHED",coverMediaId:null,noindex:!1,createdBy:"editorial",updatedBy:"editorial",editorialCover:(c=a.category,`/blog/cover/${c.toLowerCase()}`)}}let e=[d({id:"editorial-score-roadmap",category:"TOEIC_STRATEGY",slug:"chien-luoc-tang-diem-toeic-450-den-700",title:"Chiến lược tăng điểm TOEIC từ 450 lên 700: học gì trước?",excerpt:"Lộ trình ưu tiên theo từng mốc điểm, giúp bạn ngừng học dàn trải và tập trung vào những phần tạo ra nhiều điểm nhất.",seoTitle:"Cách tăng điểm TOEIC từ 450 lên 700 theo lộ trình",seoDescription:"Lộ trình tăng điểm TOEIC 450 lên 700: chọn Part ưu tiên, phân bổ thời gian, đo tiến bộ và tránh các lỗi học dàn trải.",canonicalPath:"/blog/chien-luoc-tang-diem-toeic-450-den-700",coverAlt:"Bản đồ lộ trình tăng điểm TOEIC từ 450 lên 700",socialTitle:"Tăng TOEIC 450 lên 700: lộ trình thực tế",socialDescription:"Biết rõ nên học gì trước ở từng giai đoạn thay vì luyện đề liên tục.",authorName:"TOEICGym Editorial",targetTopic:"tăng điểm TOEIC 450 lên 700",searchIntent:"informational",tags:[c("Lộ trình TOEIC","lo-trinh-toeic"),c("TOEIC 700","toeic-700")],content:`## Đừng bắt đầu bằng một lịch học thật d\xe0y
...
Điểm số kh\xf4ng tăng tuyến t\xednh từng ng\xe0y. H\xe3y nh\xecn xu hướng của 3–5 phi\xean gần nhất v\xe0 số lỗi lặp lại. Khi lỗi cũ giảm, bạn đang tiến bộ ngay cả khi một b\xe0i cụ thể kh\xf3 hơn.`}),d({id:"editorial-listening",category:"LISTENING",slug:"cach-luyen-nghe-toeic-part-3-4",title:"Cách luyện nghe TOEIC Part 3 và 4 không cần nghe từng từ",excerpt:"Kỹ thuật đọc trước câu hỏi, dự đoán bối cảnh và bắt cụm thông tin giúp bạn theo kịp hội thoại dài.",seoTitle:"Cách luyện nghe TOEIC Part 3, 4 hiệu quả",seoDescription:"Hướng dẫn luyện nghe TOEIC Part 3 và 4: đọc trước câu hỏi, bắt từ khóa, nhận diện paraphrase và sửa lỗi bằng transcript.",canonicalPath:"/blog/cach-luyen-nghe-toeic-part-3-4",coverAlt:"Tai nghe và dạng sóng minh họa luyện nghe TOEIC Part 3 và 4",socialTitle:"Nghe Part 3–4 mà không cần hiểu từng từ",socialDescription:"Một quy trình nghe chủ động, dễ áp dụng trong mỗi buổi luyện.",authorName:"TOEICGym Editorial",targetTopic:"cách luyện nghe TOEIC Part 3 4",searchIntent:"informational",tags:[c("TOEIC Listening","toeic-listening"),c("Part 3","part-3"),c("Part 4","part-4")],content:`## V\xec sao cố nghe từng từ lại l\xe0m bạn chậm hơn?
...
Sau khi học 10–15 cụm, l\xe0m một b\xe0i ngắn đ\xfang chủ đề. Đ\xe1nh dấu cụm đ\xe3 gặp v\xe0 c\xe1ch đề biến đổi ch\xfang. Chu tr\xecnh học – gặp trong c\xe2u hỏi – sửa lỗi gi\xfap từ vựng gắn với t\xedn hiệu b\xe0i thi v\xe0 được nhớ l\xe2u hơn.`}),d({id:"editorial-study-plan",category:"STUDY_PLAN",slug:"lo-trinh-hoc-toeic-30-ngay-cho-nguoi-ban-ron",title:"Lộ trình học TOEIC 30 ngày cho người bận rộn",excerpt:"Kế hoạch 30–45 phút mỗi ngày với mục tiêu rõ cho từng tuần, ngày nghỉ và cách điều chỉnh khi lỡ buổi.",seoTitle:"Lộ trình học TOEIC 30 ngày cho người bận rộn",seoDescription:"Kế hoạch học TOEIC 30 ngày, 30–45 phút mỗi ngày: đánh giá đầu vào, luyện theo điểm yếu, thi thử và ôn lỗi có hệ thống.",canonicalPath:"/blog/lo-trinh-hoc-toeic-30-ngay-cho-nguoi-ban-ron",coverAlt:"Lịch học TOEIC 30 ngày với các buổi luyện ngắn",socialTitle:"Lộ trình TOEIC 30 ngày, mỗi ngày 30–45 phút",socialDescription:"Một kế hoạch đủ nhẹ để duy trì và đủ rõ để đo tiến bộ.",authorName:"TOEICGym Editorial",targetTopic:"lộ trình học TOEIC 30 ngày",searchIntent:"informational",tags:[c("Kế hoạch học","ke-hoach-hoc"),c("30 ngày","30-ngay")],content:`## Nguy\xean tắc: buổi ngắn nhưng c\xf3 v\xf2ng phản hồi
...
Nếu bỏ lỡ một ng\xe0y, kh\xf4ng cần học gấp đ\xf4i v\xe0o h\xf4m sau. Tiếp tục lịch v\xe0 dời b\xe0i thi thử nếu cần. T\xednh li\xean tục quan trọng hơn một buổi học qu\xe1 sức khiến bạn bỏ cuộc trong nhiều ng\xe0y.`}),d({id:"editorial-exam",category:"EXAM_TIPS",slug:"kinh-nghiem-thi-toeic-ngay-thi",title:"Kinh nghiệm thi TOEIC: checklist trước và trong ngày thi",excerpt:"Chuẩn bị giấy tờ, nhịp sinh hoạt và chiến thuật phòng thi để năng lực thật không bị giảm vì lỗi nhỏ.",seoTitle:"Kinh nghiệm thi TOEIC và checklist ngày thi",seoDescription:"Checklist thi TOEIC: giấy tờ, thời gian có mặt, ăn ngủ, tô đáp án và cách xử lý khi mất tập trung trong phòng thi.",canonicalPath:"/blog/kinh-nghiem-thi-toeic-ngay-thi",coverAlt:"Checklist chuẩn bị cho ngày thi TOEIC",socialTitle:"Checklist ngày thi TOEIC để tránh mất điểm oan",socialDescription:"Những việc nhỏ nên chuẩn bị từ tối hôm trước đến khi nộp bài.",authorName:"TOEICGym Editorial",targetTopic:"kinh nghiệm thi TOEIC ngày thi",searchIntent:"informational",tags:[c("Ngày thi TOEIC","ngay-thi-toeic"),c("Checklist","checklist")],content:`## Trước ng\xe0y thi
...
Đảm bảo mọi c\xe2u đều c\xf3 đ\xe1p \xe1n nếu b\xe0i thi kh\xf4ng trừ điểm c\xe2u sai. Kiểm tra c\xe1c c\xe2u đ\xe3 đ\xe1nh dấu v\xe0 vị tr\xed t\xf4, kh\xf4ng thay đổi h\xe0ng loạt chỉ v\xec lo lắng. Sau khi nộp b\xe0i, ghi lại trải nghiệm khi c\xf2n nhớ để kế hoạch sau n\xe0y thực tế hơn.`})];a.s(["EDITORIAL_POSTS",0,e,"getEditorialPost",0,function(a){return e.find(b=>b.slug===a)??null}])},92670,a=>a.a(async(b,c)=>{try{var d=a.i(93321),e=a.i(30385),f=a.i(94758),g=a.i(81260),h=a.i(65725),i=a.i(64419),j=a.i(22937),k=b([f]);[f]=k.then?(await k)():k;class y extends Error{code;constructor(a){super(a),this.code=a}}async function l(){return f.db.select().from(g.contentPosts).orderBy((0,e.desc)(g.contentPosts.updatedAt))}async function m(){return f.db.select({postId:g.contentPostTags.postId,name:g.contentTags.name}).from(g.contentPostTags).innerJoin(g.contentTags,(0,d.eq)(g.contentPostTags.tagId,g.contentTags.id))}async function n(a=50){let b=[];try{b=await f.db.select().from(g.contentPosts).where((0,d.eq)(g.contentPosts.status,"PUBLISHED")).orderBy((0,e.desc)(g.contentPosts.publishedAt)).limit(a)}catch{console.warn("Could not load CMS posts; serving the bundled editorial library.")}let c=new Set(b.map(a=>a.slug));return[...b,...j.EDITORIAL_POSTS.filter(a=>!c.has(a.slug))].sort((a,b)=>(b.publishedAt?.getTime()??0)-(a.publishedAt?.getTime()??0)).slice(0,a)}async function o(a){let b=(await f.db.select().from(g.contentPosts).where((0,d.eq)(g.contentPosts.id,a)).limit(1))[0];return b?{...b,tags:await q(b.id)}:null}async function p(a){let b=(0,j.getEditorialPost)(a);if(b)return b;try{let b=(await f.db.select().from(g.contentPosts).where((0,d.and)((0,d.eq)(g.contentPosts.slug,a),(0,d.eq)(g.contentPosts.status,"PUBLISHED"))).limit(1))[0];return b?{...b,tags:await q(b.id)}:null}catch{return console.warn("Could not load the requested CMS post."),null}}async function q(a){return f.db.select({name:g.contentTags.name,slug:g.contentTags.slug}).from(g.contentPostTags).innerJoin(g.contentTags,(0,d.eq)(g.contentPostTags.tagId,g.contentTags.id)).where((0,d.eq)(g.contentPostTags.postId,a))}async function r(){return f.db.select({id:g.mediaAssets.id,storageKey:g.mediaAssets.storageKey,imageWidth:g.mediaAssets.imageWidth,imageHeight:g.mediaAssets.imageHeight}).from(g.mediaAssets).where((0,d.and)((0,d.eq)(g.mediaAssets.kind,"IMAGE"),(0,d.eq)(g.mediaAssets.status,"READY"),(0,d.eq)(g.mediaAssets.accessScope,"CONTENT"))).orderBy((0,e.desc)(g.mediaAssets.createdAt)).limit(100)}async function s(a){return f.db.select({id:g.contentPosts.id,title:g.contentPosts.title,slug:g.contentPosts.slug,category:g.contentPosts.category,seoTitle:g.contentPosts.seoTitle,seoDescription:g.contentPosts.seoDescription}).from(g.contentPosts).where(a?(0,d.and)((0,d.eq)(g.contentPosts.status,"PUBLISHED"),(0,d.ne)(g.contentPosts.id,a)):(0,d.eq)(g.contentPosts.status,"PUBLISHED")).orderBy((0,e.desc)(g.contentPosts.publishedAt)).limit(100)}async function t(a,b,c){for(let e of(await a.delete(g.contentPostTags).where((0,d.eq)(g.contentPostTags.postId,b)),[...new Set(c.map(a=>a.trim()).filter(Boolean))].slice(0,12))){let c=(0,h.slugify)(e);if(!c)continue;await a.insert(g.contentTags).values({name:e,slug:c}).onConflictDoUpdate({target:g.contentTags.slug,set:{name:e}});let f=(await a.select({id:g.contentTags.id}).from(g.contentTags).where((0,d.eq)(g.contentTags.slug,c)).limit(1))[0];await a.insert(g.contentPostTags).values({postId:b,tagId:f.id})}}async function u(a,b,c){let e={...b,title:b.title.trim(),slug:b.slug.trim(),excerpt:b.excerpt.trim(),content:b.content.trim(),seoTitle:b.seoTitle?.trim()||void 0,seoDescription:b.seoDescription?.trim()||void 0,canonicalPath:b.canonicalPath?.trim()||void 0,coverMediaId:b.coverMediaId||void 0,coverAlt:b.coverAlt?.trim()||void 0,socialTitle:b.socialTitle?.trim()||void 0,socialDescription:b.socialDescription?.trim()||void 0,authorName:b.authorName?.trim()||void 0,targetTopic:b.targetTopic?.trim()||void 0,searchIntent:b.searchIntent?.trim()||void 0,tags:b.tags},i=(0,h.validatePost)(e);if(i.length)throw new y(i[0]);if(!h.POST_CATEGORIES.includes(e.category))throw new y("CATEGORY_INVALID");let j={title:e.title,slug:e.slug,excerpt:e.excerpt,content:e.content,category:e.category,seoTitle:e.seoTitle??null,seoDescription:e.seoDescription??null,canonicalPath:e.canonicalPath??null,coverMediaId:e.coverMediaId??null,coverAlt:e.coverAlt??null,socialTitle:e.socialTitle??null,socialDescription:e.socialDescription??null,authorName:e.authorName??null,targetTopic:e.targetTopic??null,searchIntent:e.searchIntent??null,noindex:!!e.noindex};try{return await f.db.transaction(async b=>{let f=c;if(c){let f=(await b.select().from(g.contentPosts).where((0,d.eq)(g.contentPosts.id,c)).limit(1))[0];if(!f)throw new y("NOT_FOUND");if("PUBLISHED"===f.status&&f.slug!==e.slug)throw new y("PUBLISHED_SLUG_LOCKED");await b.update(g.contentPosts).set({...j,updatedBy:a,updatedAt:new Date}).where((0,d.eq)(g.contentPosts.id,c))}else f=(await b.insert(g.contentPosts).values({...j,createdBy:a,updatedBy:a}).returning({id:g.contentPosts.id}))[0].id;return await t(b,f,e.tags),await b.insert(g.adminAuditLogs).values({actorUserId:a,action:c?"SEO_POST_UPDATED":"SEO_POST_CREATED",metadata:{postId:f,slug:e.slug}}),f})}catch(b){let a=b.cause;if("23505"===b.code||a?.code==="23505")throw new y("SLUG_TAKEN");throw b}}async function v(a,b,c){await f.db.transaction(async e=>{let f=(await e.select().from(g.contentPosts).where((0,d.eq)(g.contentPosts.id,b)).limit(1))[0];if(!f)throw new y("NOT_FOUND");if(c){let a=(0,h.validatePost)({title:f.title,slug:f.slug,excerpt:f.excerpt,content:f.content,category:f.category,seoTitle:f.seoTitle??void 0,seoDescription:f.seoDescription??void 0,canonicalPath:f.canonicalPath??void 0,coverMediaId:f.coverMediaId??void 0,tags:[]},!0);if(a.length)throw new y(a[0])}await e.update(g.contentPosts).set({status:c?"PUBLISHED":"UNPUBLISHED",publishedAt:c?f.publishedAt??new Date:f.publishedAt,updatedBy:a,updatedAt:new Date}).where((0,d.eq)(g.contentPosts.id,b)),await e.insert(g.adminAuditLogs).values({actorUserId:a,action:c?"SEO_POST_PUBLISHED":"SEO_POST_UNPUBLISHED",metadata:{postId:b,slug:f.slug}})})}async function w(a,b){await f.db.transaction(async c=>{let e=await c.delete(g.contentPosts).where((0,d.and)((0,d.eq)(g.contentPosts.id,b),(0,d.inArray)(g.contentPosts.status,["DRAFT","UNPUBLISHED"]))).returning({id:g.contentPosts.id,slug:g.contentPosts.slug});if(!e.length)throw new y("PUBLISHED_DELETE_FORBIDDEN");await c.insert(g.adminAuditLogs).values({actorUserId:a,action:"SEO_POST_DELETED",metadata:{postId:b,slug:e[0].slug}})})}async function x(a){if(!a)return null;let b=(await f.db.select({key:g.mediaAssets.storageKey}).from(g.mediaAssets).where((0,d.and)((0,d.eq)(g.mediaAssets.id,a),(0,d.eq)(g.mediaAssets.kind,"IMAGE"),(0,d.eq)(g.mediaAssets.status,"READY"),(0,d.eq)(g.mediaAssets.accessScope,"CONTENT"))).limit(1))[0];return b?(0,i.createMediaStorage)().createReadUrl(b.key,3600):null}a.s(["BlogAdminError",0,y,"coverUrl",0,x,"deleteDraft",0,w,"getPostById",0,o,"getPublishedPost",0,p,"listAdminPostTags",0,m,"listAdminPosts",0,l,"listPostSuggestions",0,s,"listPublishedPosts",0,n,"listReadyCoverImages",0,r,"readingMinutes",0,function(a){return Math.max(1,Math.ceil(a.trim().split(/\s+/).length/220))},"savePost",0,u,"setPostPublished",0,v]),c()}catch(a){c(a)}},!1)];

//# sourceMappingURL=src_lib_blog_10vvgp8._.js.map